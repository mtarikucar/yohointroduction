...
export default function NavbarCustom({openDrawer}) {
    ...
    return (<Navbar
            className="md:fixed md:h-[12vh] sticky h-[8vh] top-0 z-40 max-w-full overflow-hidden bg-[#060417] rounded-none shadow-none backdrop-saturate-0 backdrop-blur-0 bg-opacity-100 border-none  itmx-auto flex items-center justify-between text-white">
